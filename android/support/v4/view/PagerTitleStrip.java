  ...
  implements ViewPager.Decor
{
  ...
  void updateText(int paramInt, PagerAdapter paramPagerAdapter)
  {
    ...
    if ((paramInt >= 1) && (paramPagerAdapter != null)) {
      localCharSequence = paramPagerAdapter.getPageTitle(paramInt - 1);
    }
    this.mPrevText.setText(localCharSequence);
  ...
  void updateTextPositions(int paramInt, float paramFloat, boolean paramBoolean)
  {
    ...
    i3 = k - i3 - (int)(f * i8) - i1 / 2;
    i1 = i3 + i1;
    int i7 = this.mPrevText.getBaseline();
    i8 = this.mCurrText.getBaseline();
    int i9 = this.mNextText.getBaseline();
    int i10 = Math.max(Math.max(i7, i8), i9);
    i7 = i10 - i7;
    i8 = i10 - i8;
    i9 = i10 - i9;
    i10 = i7 + this.mPrevText.getMeasuredHeight();
    int i12 = i8 + this.mCurrText.getMeasuredHeight();
    int i11 = i9 + this.mNextText.getMeasuredHeight();
    i10 = Math.max(Math.max(i10, i12), i11);
    ...
    i8 = i5 + this.mCurrText.getMeasuredHeight();
    localTextView3.layout(i3, i5, i1, i8);
    n = Math.min(n, i3 - this.mScaledTextSpacing - m);
    TextView localTextView2 = this.mPrevText;
    i5 = n + m;
    m = i4 + this.mPrevText.getMeasuredHeight();
    localTextView2.layout(n, i4, i5, m);
