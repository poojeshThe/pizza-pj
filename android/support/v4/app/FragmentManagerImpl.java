  ...
  public void dump(String paramString, FileDescriptor paramFileDescriptor, PrintWriter paramPrintWriter, String[] paramArrayOfString)
  {
    ...
    if (this.mAdded != null)
    {
      ...
      if (i2 > 0)
      {
        ...
        for (n = 0; n < i2; n++)
        {
          Fragment localFragment1 = (Fragment)this.mAdded.get(n);
          paramPrintWriter.print(paramString);
          paramPrintWriter.print("  #");
    ...
    if (this.mBackStack != null)
    {
      ...
      if (i2 > 0)
      {
        ...
        for (k = 0; k < i2; k++)
        {
          ...
          paramPrintWriter.print(k);
          paramPrintWriter.print(": ");
          paramPrintWriter.println(localObject2.toString());
    ...
    try
    {
      ...
      if (this.mBackStackIndices != null)
      {
        ...
        if (i1 > 0)
        {
          ...
          for (int i = 0; i < i1; i++)
          {
            BackStackRecord localBackStackRecord = (BackStackRecord)this.mBackStackIndices.get(i);
            paramPrintWriter.print(paramString);
            paramPrintWriter.print("  #");
          ...
          else
          {
            ...
            for (;;)
            {
              ...
              else
              {
                ...
                for (int m = -1 + this.mBackStack.size();; localBackStackRecord2--)
                {
                  if (m <= j)
                  {
                    ...
                    for (int i1 = 0;; i1++)
                    {
                      ...
                      localBackStackRecord2 = (BackStackRecord)localArrayList.get(i1);
                      if (i1 != n) {
                        j = 0;
                      } else {
                        j = 1;
                  ...
                  localArrayList.add(this.mBackStack.remove(localBackStackRecord2));
                }
              }
              j--;
            }
    ...
    for (int k = 0;; localFragment++)
    {
      if (k >= paramArrayList.size())
      {
        ...
        for (int j = 0;; localObject2++)
        {
                ...
                for (j = 0;; localObject2++)
                {
                  if (j >= localFragmentManagerState.mAdded.length)
                  {
                    ...
                    for (int i = 0;; i++)
                    {
                      ...
                      if (DEBUG) {
                        Log.v("FragmentManager", "restoreAllState: adding bse #" + i + " (index " + ((BackStackRecord)localObject2).mIndex + "): " + localObject2);
                      }
                  ...
                  if (DEBUG) {
                    Log.v("FragmentManager", "restoreAllState: making added #" + localObject2 + ": " + localObject1);
                  }
                  this.mAdded.add(localObject1);
                }
                throw new IllegalStateException("No instantiated fragment for index #" + localFragmentManagerState.mAdded[localObject2]);
              }
          ...
          localObject1 = localFragmentManagerState.mActive[localObject2];
          if (localObject1 == null)
          {
            if (DEBUG) {
              Log.v("FragmentManager", "restoreAllState: adding #" + localObject2 + ": (null)");
            }
            ...
            if (DEBUG) {
              Log.v("FragmentManager", "restoreAllState: adding avail #" + localObject2);
            }
            this.mAvailIndices.add(Integer.valueOf(localObject2));
          }
          else
          {
            localFragment = ((FragmentState)localObject1).instantiate(this.mActivity);
            if (DEBUG) {
              Log.v("FragmentManager", "restoreAllState: adding #" + localObject2 + ": " + localFragment);
            }
      ...
      Object localObject1 = (Fragment)paramArrayList.get(localFragment);
      if (DEBUG) {
    ...
    for (int n = 0;; n++)
    {
      if (n >= j)
      {
        ...
        if (k != 0)
        {
          ...
          localObject1 = "Failure saving state: active " + this.mAdded.get(localFragmentManagerState) + " has cleared index: " + arrayOfInt[localFragmentManagerState];
      ...
      localFragment = (Fragment)this.mActive.get(n);
      if (localFragment != null)
      {
        ...
        localObject1[n] = localFragmentState;
