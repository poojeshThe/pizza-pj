...
public class NavUtils
{
    ...
    throws PackageManager.NameNotFoundException
  {
    ...
    if (localObject != null) {
      localObject = new Intent().setClassName(paramComponentName.getPackageName(), (String)localObject);
    } else {
      localObject = null;
    }
    return localObject;
    ...
    throws PackageManager.NameNotFoundException
  {
    ...
    if (localObject != null) {
      localObject = new Intent().setClassName(paramContext, (String)localObject);
    } else {
      localObject = null;
    }
    return localObject;
    ...
    implements NavUtils.NavUtilsImpl
  {
    public Intent getParentActivityIntent(Activity paramActivity)
    {
      Object localObject = NavUtils.getParentActivityName(paramActivity);
      if (localObject != null) {
        localObject = new Intent().setClassName(paramActivity, (String)localObject);
      } else {
        localObject = null;
      }
      return localObject;
